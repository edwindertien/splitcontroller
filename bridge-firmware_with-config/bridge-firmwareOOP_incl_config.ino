...
mapping.insert(std::make_pair(std::make_pair("joyRXax2", 2),"foo"));
mapping.insert(std::make_pair(std::make_pair("joyRYax1", 3),"foo"));
mapping.insert(std::make_pair(std::make_pair("joyRZb11", 4),"foo"));
mapping.insert(std::make_pair(std::make_pair("joyLZb12", 7),"foo"));
mapping.insert(std::make_pair(std::make_pair("joyLYax4", 6),"foo"));
mapping.insert(std::make_pair(std::make_pair("joyLXax3", 5),"foo"));
mapping.insert(std::make_pair(std::make_pair("sqbutton", 26),"foo"));
mapping.insert(std::make_pair(std::make_pair("circbutton", 28),"foo"));
mapping.insert(std::make_pair(std::make_pair("psbutton", 30),"foo"));
mapping.insert(std::make_pair(std::make_pair("l2button", 32),"foo"));
mapping.insert(std::make_pair(std::make_pair("r2button", 34),"foo"));
mapping.insert(std::make_pair(std::make_pair("tributton", 36),"foo"));
mapping.insert(std::make_pair(std::make_pair("xbutton", 38),"foo"));
mapping.insert(std::make_pair(std::make_pair("lhat", 40),"foo"));
mapping.insert(std::make_pair(std::make_pair("rhat", 42),"foo"));
mapping.insert(std::make_pair(std::make_pair("uhat", 44),"foo"));
mapping.insert(std::make_pair(std::make_pair("dhat", 46),"foo"));
mapping.insert(std::make_pair(std::make_pair("r1button6", 48),"foo"));
mapping.insert(std::make_pair(std::make_pair("l1button5", 50),"foo"));
mapping.insert(std::make_pair(std::make_pair("optbutton",  52),"foo"));
mapping.insert(std::make_pair(std::make_pair("accx1", A5),"foo"));
mapping.insert(std::make_pair(std::make_pair("accy1", A4),"foo"));
mapping.insert(std::make_pair(std::make_pair("accx2", A1),"foo"));
mapping.insert(std::make_pair(std::make_pair("accy2", A0),"foo"));
mapping.insert(std::make_pair(std::make_pair("c_button1", A6),"foo"));
mapping.insert(std::make_pair(std::make_pair("z_button1", A7),"foo"));
mapping.insert(std::make_pair(std::make_pair("c_button2", A2),"foo"));
mapping.insert(std::make_pair(std::make_pair("z_button2", A3),"foo"));
mapping.insert(std::make_pair(std::make_pair("shrebutton", A8),"foo"));
mapping.insert(std::make_pair(std::make_pair("PWM1", 2),"foo"));
mapping.insert(std::make_pair(std::make_pair("PWM2", 3),"foo"));
mapping.insert(std::make_pair(std::make_pair("PWM3", 5),"foo"));
mapping.insert(std::make_pair(std::make_pair("PWM4", 6),"foo"));
mapping.insert(std::make_pair(std::make_pair("PWM5", 7),"foo"));
